...
function Menu(){
    ...
    return(
        <div className="menu_new flex flex-1 pad16">
            <Link to='/notes' onClick={notes} className='menulink flex flex-dir flex-2 gap4'>
            ...
            <Link to='/practice' onClick={practice} className='menulink flex flex-dir flex-2 gap4'>
            ...
            <Link to='/courses' onClick={learn} className='menulink flex flex-dir flex-2 gap4'>
                ...
                <p className={count == 3 ? "menuitem menuItemColor" : "menuitem"}>Course</p>
            </Link>
